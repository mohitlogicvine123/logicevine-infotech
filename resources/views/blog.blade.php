                ...
                <div class="overflow-hidden bg-white rounded-[8px] shadow-lg h-full sm:p-2 p-1.5 border">   
                    <div class="relative">
                        <a href="#" title="" class="inline-block overflow-hidden rounded-[8px] group h-[230px] w-full">
                            <img class="object-cover w-full h-full group-hover:scale-125 transition-all duration-300 ease-in-out" src="" alt="" />
                        </a>
                    ...
                    <div class="px-1 md:pt-2.5 pt-2">
                        ...
                        <p class="md:mt-2.5 mt-2 text-[15px] text-gray-800 leading-[25px] line-clamp-3">{{$item->description ?? 'Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.'}}</p>
